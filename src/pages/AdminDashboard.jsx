          ...
          <div className="flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between bg-slate-900/50 p-4 rounded-3xl border border-slate-800">
            <div className="flex flex-wrap gap-2">
              <button
                ...
                className={`px-5 py-2.5 rounded-2xl text-sm font-bold transition duration-300 ${
                  activeTab === "students"
                    ? "bg-purple-600 text-white shadow-lg shadow-purple-600/20"
                    : "bg-slate-950/60 text-slate-400 border border-slate-800 hover:bg-slate-800 hover:text-white"
                }`}
              >
              ...
              >
                🏠 Boarding Stays ({boardings.length})
              </button>
            </div>
